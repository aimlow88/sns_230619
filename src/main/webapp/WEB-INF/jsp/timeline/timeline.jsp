		...
		<div class="d-flex justify-content-center">
			<div class="w-50">
				...
				<div class="bg-light d-flex justify-content-between align-items-center">
					<span class="display-4 font-weight-bold ml-4">${post.userId}</span>
					<input type="button" id="deleteBtn" name="deleteBtn" class="btn btn-warning mr-4" value="•••">
				</div>
			
				<div class="d-flex justify-content-center mt-3">
					<img src="${post.imagePath}" alt="게시글 이미지" width="780px">
				</div>
				...
				<div class="d-flex align-items-center">
					<span class="display-5 font-weight-bold">${post.userId}</span>
					<span class="display-5 text-dark ml-2">${post.content}</span>
				</div>
				...
				<table class="table mt-3" border=0>
					...
					<tbody>
						<tr>
							<td class="display-5 font-weight-bold">hagulu</td>
							<td>분류가 잘 되었군요~</td>
						</tr>
						<tr>
							<td class="display-5 font-weight-bold">bada0126</td>
							<td>이게 모야???</td>
						</tr>
						<tr>
							<td class="display-5 font-weight-bold">jun_coffee</td>
							<td>철이 없었죠. 분류를 위해 클러스터를 썼다는게...</td>
						</tr>
					</tbody>
				</table>
				...
				<c:if test="${!empty userId}">
					<div class="d-flex align-items-center">
						...
						<button type="button" id="addContentBtn" name="addContentBtn" class="addContentBtn btn btn-white" value="${post.id}">게시</button>
					</div>
				</c:if>
